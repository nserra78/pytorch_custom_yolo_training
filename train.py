...
parser.add_argument("--data_config_path", type=str, default="config/barcodes.data", help="path to data config file")
parser.add_argument("--weights_path", type=str, default="config/my_weights.weights", help="path to weights file")
parser.add_argument("--class_path", type=str, default="config/barcodes.names", help="path to class label file")
...
for epoch in range(opt.epochs):
    for batch_i, (_, imgs, targets) in enumerate(dataloader):
        ...
        message = "[Epoch %d/%d, Batch %d/%d] [Losses: x %f, y %f, w %f, h %f, conf %f, cls %f, total %f, recall: %.5f, precision: %.5f]"% (
                epoch,
                opt.epochs,
                batch_i,
                len(dataloader),
